...
const searchLocalPolicy = (policy, plugin, apiName) => {
  ...
  let absoluteApi = _.get(siapi.api, absoluteApiName);
  ...
  const api = _.get(siapi.api, apiName);
...
const policyResolvers = [
  {
    ...
    get: policy => {
      ...
      return getPolicyIn(_.get(siapi, ['api', api]), policyName);
    },
  },
  {
    name: 'admin',
    ...
    get: policy => {
      return getPolicyIn(_.get(siapi, 'admin'), stripPolicy(policy, ADMIN_PREFIX));
    },
  },
  {
    name: 'plugin',
    ...
    get(policy) {
      ...
      return getPolicyIn(_.get(siapi, ['plugins', plugin]), policyName);
    },
  },
  {
    name: 'global',
    ...
    get(policy) {
      return getPolicyIn(siapi, stripPolicy(policy, GLOBAL_PREFIX));
    },
  },
];
